...
export async function listComments(
  ...
  let q = baseRef.collection("comments").orderBy("__name__").limit(200) as FirebaseFirestore.Query;
 ...
 * author OR an owner/admin of the team; otherwise 403. 404 if unknown.
 */
