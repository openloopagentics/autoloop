...
mkdir -p web/public/skill/daloop-vision web/public/skill/daloop
cp plugins/daloop-reporting/skills/daloop-vision/SKILL.md web/public/skill/daloop-vision/SKILL.md
cp plugins/daloop-reporting/skills/daloop/SKILL.md        web/public/skill/daloop/SKILL.md
...
echo "✓ synced daloop-vision/daloop SKILL.md + vision-schema.mjs → web/public/skill/ (curl installer)"
