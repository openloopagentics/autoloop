...
describe("MessagesTab", () => {
  it("renders user bubble with msg--user class", () => {
    const { container } = render(<MessagesTab messages={[userMsg]} onSend={vi.fn()} />);
  ...
  it("renders agent bubble with msg--agent class", () => {
    const { container } = render(<MessagesTab messages={[agentMsg]} onSend={vi.fn()} />);
  ...
  it("shows delivered pill on user message with status=delivered", () => {
    const { container } = render(<MessagesTab messages={[deliveredMsg]} onSend={vi.fn()} />);
